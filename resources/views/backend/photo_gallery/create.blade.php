...
@section('title','Add Photo Gallery Image')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Add Photo Gallery Image</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Add Photo Gallery Image</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="photo_title" class="form-control @error('photo_title') is-invalid @enderror" value="{{ old('photo_title') }}" id="exampleInputFullphoto_title" placeholder="Enter photo title">
                        @error('photo_title')
