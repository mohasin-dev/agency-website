                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" type="text" name="office_location_map"
                                        class="form-control @error('office_location_map') is-invalid @enderror"
                                        id="exampleInputFulloffice_location_map"
                                        placeholder="Enter office location map">{{ old('office_location_map', $setting->office_location_map) }}</textarea>
