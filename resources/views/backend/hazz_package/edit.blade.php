...
@section('title', 'Edit Hazz Package')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Hazz Package</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Edit Hazz Package</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        <form action="{{ route('admin.hazz-package.update', $hazzPackage) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title', $hazzPackage->title) }}" id="exampleInputFulltitle"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country_id"
                                        ...
                                        @foreach ($countries as $country)
                                            <option {{ $country->id == $hazzPackage->country_id ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="short_description"
                                        ...
                                        placeholder="Enter company name">{{ old('short_description', $hazzPackage->short_description) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="@error('package_overview') is-invalid @enderror"
                                        name="package_overview">{!! old('package_overview', $hazzPackage->package_overview) !!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="@error('itinerary') is-invalid @enderror"
                                        name="itinerary">{!! old('itinerary', $hazzPackage->itinerary) !!}</textarea>
                                    @error('itinerary')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="@error('hotel_details') is-invalid @enderror"
                                        name="hotel_details">{!! old('hotel_details', $hazzPackage->hotel_details) !!}</textarea>
                                    @error('hotel_details')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="@error('notes') is-invalid @enderror"
                                        name="notes">{!! old('notes', $hazzPackage->notes) !!}</textarea>
                                    @error('notes')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="@error('policy') is-invalid @enderror"
                                        name="policy">{!! old('policy', $hazzPackage->policy) !!}</textarea>
                                    @error('policy')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="@error('rate_and_dates') is-invalid @enderror"
                                        name="rate_and_dates">{!! old('rate_and_dates', $hazzPackage->rate_and_dates) !!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" {{ $hazzPackage->is_featured == 'Yes' ? 'checked' : '' }}
