            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div
                    ...
                    <ul class="xs-text-center">
                        ...
                        <li><a href="#" class="text-white-hover">About Dubai</a></li>
                        <li></li>
                    </ul>
                    <!-- end breadcrumb -->
                </div>
        ...
        <div class="container">
            {{-- <div class="row justify-content-center">
                <div class="col-12 col-lg-5 col-sm-7 text-center margin-5-rem-bottom sm-margin-3-rem-bottom">
                    <h5 class="alt-font font-weight-500 text-extra-dark-gray d-inline-block letter-spacing-minus-1-half">Blog Title</h5>
                </div>
            </div> --}}
                    ...
                    <div class="col-md-12">
                        <div class="card-body ">
                            <img style="max-width: 100%; display: block; margin: auto;" class="img-fluid"
                                src="{{ asset('assets/backend/img/dubai.jpg') }}" alt="" data-no-retina="">
                        </div>
                    </div>
                </div><br><br>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-md-12 text-center margin-four-bottom">
                                        <h2 class="alt-font text-extra-dark-gray font-weight-500">Our services</h2>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-12 col-xl-5 col-lg-6 col-md-8">
                                        <ul class="list-style-02">
                                            <li class="margin-20px-bottom">
                                                <i class="feather icon-feather-arrow-right-circle text-large text-fast-blue position-relative margin-10px-right"
                                                    aria-hidden="true"></i>
                                                <span> Let's collaborate make an impact in the business</span>
                                            </li>
                                            <li class="margin-20px-bottom">
                                                <i class="feather icon-feather-arrow-right-circle text-large text-fast-blue position-relative margin-10px-right"
                                                    aria-hidden="true"></i>
                                                <span> A satisfied customer is the best business starts</span>
                                            </li>
                                            <li class="margin-20px-bottom">
                                                <i class="feather icon-feather-arrow-right-circle text-large text-fast-blue position-relative margin-10px-right"
                                                    aria-hidden="true"></i>
                                                <span> Expertise to build the things that matter for you</span>
                                            </li>
                                            <li class="margin-20px-bottom">
                                                <i class="feather icon-feather-arrow-right-circle text-large text-fast-blue position-relative margin-10px-right"
                                                    aria-hidden="true"></i>
                    ...
                    <div class="col-md-6">
                        ...
                        <section class="big-section">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-md-12 text-center margin-four-bottom">
                                        <h2 class="alt-font text-extra-dark-gray font-weight-500">Features</h2>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                                    <div class="col-12 col-xl-5 col-lg-6 col-md-8">
